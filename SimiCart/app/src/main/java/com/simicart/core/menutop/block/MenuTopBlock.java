...
public class MenuTopBlock extends SimiBlock implements MenuTopDelegate {
	...
	protected LayoutParams param_logo_cancel;
	protected LayoutParams param_logo;
	protected LayoutParams param_search;
	protected LayoutParams param_search_cancel;
	...
	private void initSearch() {
		...
		param_search = new LayoutParams(0,
				LayoutParams.WRAP_CONTENT, 0.5f);
		param_logo = new LayoutParams(0,
				LayoutParams.WRAP_CONTENT, 0.5f);
		param_search_cancel = new LayoutParams(0,
				LayoutParams.WRAP_CONTENT, 0.05f);
		param_logo_cancel = new LayoutParams(0,
