...
public class SignInBlock extends SimiBlock implements SignInDelegate {
	...
	public void initView() {
		...
		cb_remember_password.setText(Config.getInstance().getText("Remember password"));
		cb_remember_password.setTextColor(Config.getInstance()
		 ...
		 txt_label_create_account.setText(Config.getInstance().getText("Don't have an account ") + "?");
