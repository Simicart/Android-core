...
public class ShippingFragment extends SimiFragment {

	View rootView;
	ArrayList<ShippingMethod> shippingList = new ArrayList<ShippingMethod>();
	ShippingFragment fshipping;
	LinearLayout child;
	int pos = -1;
	View mImageView;
	String code = "";
...
//		this.fshipping = this;
//	}
	public static ShippingFragment newInstance (ArrayList<ShippingMethod> shippingMethods){
