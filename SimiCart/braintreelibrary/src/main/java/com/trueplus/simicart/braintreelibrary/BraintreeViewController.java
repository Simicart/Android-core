...
public abstract class BraintreeViewController {
    ...
    protected String getCustomizedCallToAction() {
        String actionText = "";
        actionText = mPaymentRequest.getSubmitButtonText();
    ...
    private void initDescriptionView() {
        if (!TextUtils.isEmpty(mPaymentRequest.getPrimaryDescription())) {
            initDescriptionSubview(R.id.bt_primary_description, mPaymentRequest
                    .getPrimaryDescription());
            initDescriptionSubview(R.id.bt_secondary_description, mPaymentRequest
                    .getSecondaryDescription());
            initDescriptionSubview(R.id.bt_description_amount, mPaymentRequest
                    .getAmount());
