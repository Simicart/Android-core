...
public abstract class PaymentMethodBuilder<T> {
    ...
    /**
     * @param validate Flag to denote when the associated {@link com.braintreepayments.api.models.PaymentMethodNonce}
     *   will be validated. When set to {@code true}, the {@link com.braintreepayments.api.models.PaymentMethodNonce}
     *   will be validated immediately. When {@code false}, the {@link com.braintreepayments.api.models.PaymentMethodNonce}
    ...
    /**
     * @return String representation of {@link com.braintreepayments.api.models.PaymentMethodNonce} for API use.
     */
    public String build() {
