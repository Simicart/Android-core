...
public final class AccessToken implements Parcelable {
	...
	public AccessToken(final String accessToken, final String applicationId,
			final String userId,
			@Nullable final Collection<String> permissions,
			@Nullable final Collection<String> declinedPermissions,
			@Nullable final AccessTokenSource accessTokenSource,
			@Nullable final Date expirationTime,
			@Nullable final Date lastRefreshTime) {
	 ...
	 *            token
	 */
	@SuppressLint("NewApi") public static void createFromNativeLinkingIntent(Intent intent,
