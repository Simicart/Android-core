...
public class SearchStoreFragment extends SimiFragment {
	private View view;
...
//	}
	public static SearchStoreFragment newInstance (SearchObject searchObject){
...
//				fragment.setSearch_object(search_object);
	...
	public class SearchLoad extends AsyncTask<Void, Void, JSONObject> {
		...
		protected JSONObject doInBackground(Void... params) {
			...
			List<String> tagParers = tagParser.getResult(tagObject);
			if(tagParers != null){
			for (int i = 0; i < tagParers.size(); i++) {
				list_tag.add(tagParers.get(i));
			}
			}
			return tagObject;
		}
