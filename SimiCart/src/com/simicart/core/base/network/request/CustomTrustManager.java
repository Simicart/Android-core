...
public class CustomTrustManager implements X509TrustManager {
    ...
    public void checkServerTrusted(X509Certificate[] chain, String authType) throws java.security.cert.CertificateException {
        try {
        	...
        	Log.e("CustomTrustManager ","checkServerTrusted CertificateException" + originalException.getMessage());
            ...
            try {
            	...
            	Log.e("CustomTrustManager ","checkServerTrusted Exception" + originalException.getMessage());
