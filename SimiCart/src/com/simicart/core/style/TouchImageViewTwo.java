...
public class TouchImageViewTwo extends ImageView {
	...
	public TouchImageViewTwo(Context context) {
		super(context);
		sharedConstructing(context);
	}

	public TouchImageViewTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		sharedConstructing(context);
	}
	 ...
	 * 
	 * @param TouchImageViewTwo
	 */
	public void setZoom(TouchImageViewTwo img) {
	...
	// // show previous
	// if (null != mDelegate) {
	// mDelegate.onShowPreviousProduct();
	// }
	// }
	...
	private class GestureListener extends
		...
		public boolean onSingleTapConfirmed(MotionEvent e) {
			if (null != mParentController) {
				mParentController.onVisibleTopBottom(true);
			}
		...
		public void onLongPress(MotionEvent e) {
			if (null != mParentController) {
				mParentController.onVisibleTopBottom(false);
			}
			performLongClick();
		}
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			/*
			 * if(e2.getX() - e1.getX() > 50) { resetZoom(); } else if(e2.getX()
			 * - e1.getX() < -50) { resetZoom(); }
			 */
