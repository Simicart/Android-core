package com.simicart.core.style.circlerefresh;
...
public class AnimationView extends View {
    ...
    public void setAniForeColor(int color) {
        mBallPaint.setColor(Config.getInstance().getColorMain());
        mOutPaint.setColor(Config.getInstance().getColorMain());
//        setBackgroundColor(Config.getInstance().getColorMain());
    }
