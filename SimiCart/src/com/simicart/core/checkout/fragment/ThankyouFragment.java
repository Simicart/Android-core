...
public class ThankyouFragment extends SimiFragment implements OnKeyListener {
	...
	private int mTypeCheckout;

	public static ThankyouFragment newInstance(String message,
		...
		setData(Constants.KeyData.MESSAGE, message,
				Constants.KeyData.TYPE_STRING, bundle);
		if (jsonObject != null) {
			setData(Constants.KeyData.JSON_FILTER, jsonObject.toString(),
	...
	public void setTypeCheckout(int type_checkout) {
		mTypeCheckout = type_checkout;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (getArguments() != null) {
			message = (String) getData(Constants.KeyData.MESSAGE,
		...
		if (mTypeCheckout != Constants.NEW_AS_GUEST && !DataLocal.isSignInComplete()) {
			autoSignin();
		}
	...
	private void initView(View rootView) {
		...
		txt_content_message
				.setText(Config
						.getInstance()
						.getText(
								"You will receive an order confirmation email with detail of your order and alink to track its progress"));
